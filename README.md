...
| -l, --lambda-anchor FLOAT | Balance: Trade-off between path-derived coordinates (1.0) and topology smoothing (0.0). Valid Range: [0.0, 1.0] Recommendations: Standard Graphs: 0.6 – 0.8 (Default: 0.7). Deep Graphs (10+ paths): Use values closer to 1.0 (path coordinates are more representative). Shallow/Discontinuous/Messy Graphs: Use values < 0.5 for better stability. |
